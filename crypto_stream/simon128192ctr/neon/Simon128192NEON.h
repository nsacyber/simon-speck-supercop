...
#define RKBS4(rk,r,_V) (rk[r][3]=_D4 ^ rk[r-3][3] ^ ROR4(rk[r-1][2]^rk[r-1][3]), \
                        rk[r][2]=_D4 ^ rk[r-3][2] ^ ROR4(rk[r-1][1]^rk[r-1][2]), \
                        rk[r][1]=_C4 ^ rk[r-3][1] ^ ROR4(rk[r-1][0]^rk[r-1][1]), \
                        rk[r][0]=_V ^ rk[r-3][0] ^ rk[r-1][3] ^ ROR4(rk[r-1][0]))

#define EKBS4(rk) (RKBS4(rk,3,_D4),  RKBS4(rk,4,_D4),  RKBS4(rk,5,_C4),  RKBS4(rk,6,_D4),  RKBS4(rk,7,_D4),  RKBS4(rk,8,_C4),  RKBS4(rk,9,_D4),	\
                   RKBS4(rk,10,_D4), RKBS4(rk,11,_D4), RKBS4(rk,12,_C4), RKBS4(rk,13,_D4), RKBS4(rk,14,_C4), RKBS4(rk,15,_D4), RKBS4(rk,16,_D4), \
                   RKBS4(rk,17,_C4), RKBS4(rk,18,_C4), RKBS4(rk,19,_C4), RKBS4(rk,20,_D4), RKBS4(rk,21,_D4), RKBS4(rk,22,_C4), RKBS4(rk,23,_C4), \
                   RKBS4(rk,24,_D4), RKBS4(rk,25,_C4), RKBS4(rk,26,_D4), RKBS4(rk,27,_D4), RKBS4(rk,28,_D4), RKBS4(rk,29,_D4), RKBS4(rk,30,_C4), \
                   RKBS4(rk,31,_C4), RKBS4(rk,32,_C4), RKBS4(rk,33,_C4), RKBS4(rk,34,_C4), RKBS4(rk,35,_C4), RKBS4(rk,36,_D4), RKBS4(rk,37,_C4), \
                   RKBS4(rk,38,_C4), RKBS4(rk,39,_D4), RKBS4(rk,40,_C4), RKBS4(rk,41,_C4), RKBS4(rk,42,_C4), RKBS4(rk,43,_D4), RKBS4(rk,44,_C4), \
                   RKBS4(rk,45,_D4), RKBS4(rk,46,_C4), RKBS4(rk,47,_C4), RKBS4(rk,48,_D4), RKBS4(rk,49,_D4), RKBS4(rk,50,_D4), RKBS4(rk,51,_C4), \
                   RKBS4(rk,52,_C4), RKBS4(rk,53,_D4), RKBS4(rk,54,_D4), RKBS4(rk,55,_C4), RKBS4(rk,56,_D4), RKBS4(rk,57,_C4), RKBS4(rk,58,_C4), \
                   RKBS4(rk,59,_C4), RKBS4(rk,60,_C4), RKBS4(rk,61,_D4), RKBS4(rk,62,_D4), RKBS4(rk,63,_D4), RKBS4(rk,64,_D4), RKBS4(rk,65,_D4), \
                   RKBS4(rk,66,_D4), RKBS4(rk,67,_C4), RKBS4(rk,68,_D4))


#define _D8 SET(0xffffffffffffffffLL,0xffffffffffffffffLL)
#define _C8 SET(0xffffffffffffff00LL,0xffffffffffffff00LL)

#define RKBS8(rk,r,_V) (rk[r][7]= _D8 ^ rk[r-3][7] ^ ROR8(rk[r-1][2] ^ rk[r-1][3]), \
                        rk[r][6]= _D8 ^ rk[r-3][6] ^ ROR8(rk[r-1][1] ^ rk[r-1][2]), \
                        rk[r][5]= _D8 ^ rk[r-3][5] ^ ROR8(rk[r-1][0] ^ rk[r-1][1]), \
                        rk[r][4]= _D8 ^ rk[r-3][4] ^ rk[r-1][7] ^ ROR8(rk[r-1][0]), \
                        rk[r][3]= _D8 ^ rk[r-3][3] ^ rk[r-1][6] ^ rk[r-1][7], \
                        rk[r][2]= _D8 ^ rk[r-3][2] ^ rk[r-1][5] ^ rk[r-1][6], \
                        rk[r][1]= _C8 ^ rk[r-3][1] ^ rk[r-1][4] ^ rk[r-1][5], \
                        rk[r][0]= _V ^ rk[r-3][0] ^ rk[r-1][3] ^ rk[r-1][4])

#define EKBS8(rk) (RKBS8(rk,3,_D8),  RKBS8(rk,4,_D8),  RKBS8(rk,5,_C8),  RKBS8(rk,6,_D8),  RKBS8(rk,7,_D8),  RKBS8(rk,8,_C8),  RKBS8(rk,9,_D8),	\
                   RKBS8(rk,10,_D8), RKBS8(rk,11,_D8), RKBS8(rk,12,_C8), RKBS8(rk,13,_D8), RKBS8(rk,14,_C8), RKBS8(rk,15,_D8), RKBS8(rk,16,_D8), \
                   RKBS8(rk,17,_C8), RKBS8(rk,18,_C8), RKBS8(rk,19,_C8), RKBS8(rk,20,_D8), RKBS8(rk,21,_D8), RKBS8(rk,22,_C8), RKBS8(rk,23,_C8), \
                   RKBS8(rk,24,_D8), RKBS8(rk,25,_C8), RKBS8(rk,26,_D8), RKBS8(rk,27,_D8), RKBS8(rk,28,_D8), RKBS8(rk,29,_D8), RKBS8(rk,30,_C8), \
                   RKBS8(rk,31,_C8), RKBS8(rk,32,_C8), RKBS8(rk,33,_C8), RKBS8(rk,34,_C8), RKBS8(rk,35,_C8), RKBS8(rk,36,_D8), RKBS8(rk,37,_C8), \
                   RKBS8(rk,38,_C8), RKBS8(rk,39,_D8), RKBS8(rk,40,_C8), RKBS8(rk,41,_C8), RKBS8(rk,42,_C8), RKBS8(rk,43,_D8), RKBS8(rk,44,_C8), \
                   RKBS8(rk,45,_D8), RKBS8(rk,46,_C8), RKBS8(rk,47,_C8), RKBS8(rk,48,_D8), RKBS8(rk,49,_D8), RKBS8(rk,50,_D8), RKBS8(rk,51,_C8), \
                   RKBS8(rk,52,_C8), RKBS8(rk,53,_D8), RKBS8(rk,54,_D8), RKBS8(rk,55,_C8), RKBS8(rk,56,_D8), RKBS8(rk,57,_C8), RKBS8(rk,58,_C8), \
                   RKBS8(rk,59,_C8), RKBS8(rk,60,_C8), RKBS8(rk,61,_D8), RKBS8(rk,62,_D8), RKBS8(rk,63,_D8), RKBS8(rk,64,_D8), RKBS8(rk,65,_D8), \
                   RKBS8(rk,66,_D8), RKBS8(rk,67,_C8), RKBS8(rk,68,_D8))
