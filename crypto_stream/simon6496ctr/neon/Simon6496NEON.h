...
#define _D4 (u128)SET(0xffffffffffffffffLL,0xffffffffffffffffLL)
#define _C4 (u128)SET(0xfffffff0fffffff0LL,0xfffffff0fffffff0LL)

#define RKBS4(rk,r,_V) (rk[r][3]=XOR(XOR(_D4,rk[r-3][3]),ROR4(XOR(rk[r-1][2],rk[r-1][3]))),\
                        rk[r][2]=XOR(XOR(_D4,rk[r-3][2]),ROR4(XOR(rk[r-1][1],rk[r-1][2]))),\
                        rk[r][1]=XOR(XOR(_C4,rk[r-3][1]),ROR4(XOR(rk[r-1][0],rk[r-1][1]))),\
                        rk[r][0]=XOR(XOR(XOR(_V,rk[r-3][0]),rk[r-1][3]),ROR4(rk[r-1][0])))

#define EKBS4(rk) (RKBS4(rk,3,_D4),  RKBS4(rk,4,_C4),  RKBS4(rk,5,_D4),  RKBS4(rk,6,_C4),  RKBS4(rk,7,_D4),  RKBS4(rk,8,_D4), \
                   RKBS4(rk,9,_D4),  RKBS4(rk,10,_D4), RKBS4(rk,11,_C4), RKBS4(rk,12,_D4), RKBS4(rk,13,_D4), RKBS4(rk,14,_D4), \
                   RKBS4(rk,15,_C4), RKBS4(rk,16,_C4), RKBS4(rk,17,_C4), RKBS4(rk,18,_C4), RKBS4(rk,19,_C4), RKBS4(rk,20,_C4), \
                   RKBS4(rk,21,_D4), RKBS4(rk,22,_D4), RKBS4(rk,23,_C4), RKBS4(rk,24,_D4), RKBS4(rk,25,_C4), RKBS4(rk,26,_C4), \
                   RKBS4(rk,27,_D4), RKBS4(rk,28,_C4), RKBS4(rk,29,_C4), RKBS4(rk,30,_D4), RKBS4(rk,31,_D4), RKBS4(rk,32,_C4), \
                   RKBS4(rk,33,_C4), RKBS4(rk,34,_C4), RKBS4(rk,35,_D4), RKBS4(rk,36,_C4), RKBS4(rk,37,_D4), RKBS4(rk,38,_C4), \
                   RKBS4(rk,39,_C4), RKBS4(rk,40,_C4), RKBS4(rk,41,_C4))

#define _D8 (u128)SET(0xffffffffffffffffLL,0xffffffffffffffffLL)
#define _C8 (u128)SET(0xffffff00ffffff00LL,0xffffff00ffffff00LL)
...
#define EKBS8(rk) (RKBS8(rk,3,_D8),  RKBS8(rk,4,_C8),  RKBS8(rk,5,_D8),  RKBS8(rk,6,_C8),  RKBS8(rk,7,_D8),  RKBS8(rk,8,_D8), \
                   RKBS8(rk,9,_D8),  RKBS8(rk,10,_D8), RKBS8(rk,11,_C8), RKBS8(rk,12,_D8), RKBS8(rk,13,_D8), RKBS8(rk,14,_D8), \
                   RKBS8(rk,15,_C8), RKBS8(rk,16,_C8), RKBS8(rk,17,_C8), RKBS8(rk,18,_C8), RKBS8(rk,19,_C8), RKBS8(rk,20,_C8), \
                   RKBS8(rk,21,_D8), RKBS8(rk,22,_D8), RKBS8(rk,23,_C8), RKBS8(rk,24,_D8), RKBS8(rk,25,_C8), RKBS8(rk,26,_C8), \
                   RKBS8(rk,27,_D8), RKBS8(rk,28,_C8), RKBS8(rk,29,_C8), RKBS8(rk,30,_D8), RKBS8(rk,31,_D8), RKBS8(rk,32,_C8), \
                   RKBS8(rk,33,_C8), RKBS8(rk,34,_C8), RKBS8(rk,35,_D8), RKBS8(rk,36,_C8), RKBS8(rk,37,_D8), RKBS8(rk,38,_C8), \
                   RKBS8(rk,39,_C8), RKBS8(rk,40,_C8), RKBS8(rk,41,_C8))
