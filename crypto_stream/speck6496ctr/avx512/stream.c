...
#include "stdlib.h"
#include "string.h"
#include "Speck6496AVX512.h"

int crypto_stream_speck6496ctr_avx512(unsigned char *out, unsigned long long outlen, const unsigned char *n, const unsigned char *k);
inline __attribute__((always_inline)) int Encrypt(unsigned char *out, u32 nonce[], u512 rk[], u32 key[], int numbytes);
int crypto_stream_speck6496ctr_avx512_xor(unsigned char *out, const unsigned char *in, unsigned long long inlen, const unsigned char *n, const unsigned char *k);
...
int crypto_stream_speck6496ctr_avx512(
  unsigned char *out, 
...
{
  int i;
  u32 nonce[2],K[3],key[26],A,B,C,x,y;
...
int crypto_stream_speck6496ctr_avx512_xor(
  unsigned char *out, 
