//AVX512 C code for SPECK 128/128
...
#include <stdlib.h>
#include <string.h>
#include "Speck128128AVX512.h"

int crypto_stream_speck128128ctr_avx2(unsigned char *out, unsigned long long outlen, const unsigned char *n, const unsigned char *k);
inline __attribute__((always_inline)) int Encrypt(unsigned char *out, u64 nonce[], u512 rk[], u64 key[], int numbytes);
int crypto_stream_speck128128ctr_avx512_xor(unsigned char *out, const unsigned char *in, unsigned long long inlen, const unsigned char *n, const unsigned char *k);
...
int crypto_stream_speck128128ctr_avx512(
  unsigned char *out, 
...
{
  int i;
  u64 nonce[2],K[2],key[32],A,B,x,y;
...
int crypto_stream_speck128128ctr_avx512_xor(
  unsigned char *out, 
