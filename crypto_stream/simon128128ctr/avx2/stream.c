//AVX2 C code for a counter mode implementation of SIMON 128/128.
...
int crypto_stream_simon128128ctr_avx2(
  unsigned char *out, 
...
int crypto_stream_simon128128ctr_avx2_xor(
  unsigned char *out, 
